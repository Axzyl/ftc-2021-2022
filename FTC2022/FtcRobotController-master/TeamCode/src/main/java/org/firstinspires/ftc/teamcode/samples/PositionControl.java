...
public class PositionControl {
    ...
    private final double MIN_VW = 30 * Math.PI /180;          // 10 degree per second
    ...
    public PositionControl.PositionControlThread positionControlThread = null;

    private PositionEstimation positionEstimation = null;

    public PositionControl(MecanumRobotDrive robot, PositionEstimation positionEstimation){
        this.robot = robot;
    ...
    {
        this.robot.rf.setPower(0);
        this.robot.lf.setPower(0);
        this.robot.rr.setPower(0);
        this.robot.lr.setPower(0);
        this.taskDone = true;
    }
...
*/
        ...
        this.robot.rf.setPower(rightPowerF);
        this.robot.rr.setPower(rightPowerR);
        this.robot.lr.setPower(leftPowerR);
        this.robot.lf.setPower(leftPowerF);
    }
    ...
    public void InterruptThread(){
        if(positionControlThread.isAlive()) positionControlThread.interrupt();
    }
